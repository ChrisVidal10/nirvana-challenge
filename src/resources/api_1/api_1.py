...
class Api1(BaseExtApi, BaseExternalApiInterface):

    # Sample Database Implementation for Api #1
    _DB = {
        "1": {"deductible": 1000, "stop_loss": 10000, "oop_max": 5000},
        "2": {"deductible": 2000, "stop_loss": 20000, "oop_max": 10000},
        "3": {"deductible": 3000, "stop_loss": 30000, "oop_max": 15000},
        "4": {"deductible": 4000, "stop_loss": 40000, "oop_max": 20000},
    }
    ...
    def fetch_info(self) -> Dict[str, int]:
        ...
        # In this method would be necessary to implement a call to a real API_1
